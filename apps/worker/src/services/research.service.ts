...
import { ResearchProject, type ResearchProjectDocument, type ResearchStatus } from "@smart-ai/core/models/ResearchProject";
import { logger } from "@smart-ai/core/utils/logger";
import { searchPapers } from "@smart-ai/core/services/research/scholar.service";
import { searchPatents } from "@smart-ai/core/services/research/patents.service";
import { ideateFromSources, planResearchQueries } from "@smart-ai/core/services/research/researchIdeation.service";
import { captureSnapshots } from "./researchSnapshot.service";

/**
 * Runs a Research Lab project end to end — claimed and run by this worker's
 * poll loop (see polling/researchJobs.ts) once the web app flips a project to
 * "queued". Each stage persists its output before the next starts, so a crash
 * mid-way still leaves the learner with whatever was gathered, and the
 * progress line stays honest.
 */
