...
export const LearningProfile = (models.LearningProfile as Model<LearningProfileDocument>) ?? model<LearningProfileDocument>("LearningProfile", learningProfileSchema);
