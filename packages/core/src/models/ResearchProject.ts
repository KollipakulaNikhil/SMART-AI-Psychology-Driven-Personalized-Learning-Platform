...
export const ResearchProject = (models.ResearchProject as Model<ResearchProjectDocument>) ?? model<ResearchProjectDocument>("ResearchProject", researchProjectSchema);
